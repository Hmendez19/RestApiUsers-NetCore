...
public class LastName:ValueValidator
{
    ...
    private void EnsureValueNotEmpty(string value)
    {
        ...
        {
            throw new FirstNameNotValidException("LastName no puede ser vacío");
        }
    }
    ...
    private void EnsureValueNotToExceedCharacterLength(string value)
    {
        ...
        {
            throw new UnprocessableContentException($"LastName no puede tener más de {maxLength} caracteres");
        }
    }
}